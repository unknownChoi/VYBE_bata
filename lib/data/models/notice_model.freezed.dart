...
mixin _$NoticeModel {
 ...
 List<String> get imageUrls; String get category;// "notice" | "update" | "event"
 bool get isPinned; bool get isActive; DateTime get publishedAt;// 목록 정렬 키
...
@override
int get hashCode => Object.hash(runtimeType,noticeId,title,content,const DeepCollectionEquality().hash(imageUrls),category,isPinned,isActive,publishedAt,authorName,createdAt,updatedAt);

@override
String toString() {
  return 'NoticeModel(noticeId: $noticeId, title: $title, content: $content, imageUrls: $imageUrls, category: $category, isPinned: $isPinned, isActive: $isActive, publishedAt: $publishedAt, authorName: $authorName, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String noticeId, String title, String content, List<String> imageUrls, String category, bool isPinned, bool isActive, DateTime publishedAt, String authorName, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of NoticeModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? noticeId = null,Object? title = null,Object? content = null,Object? imageUrls = null,Object? category = null,Object? isPinned = null,Object? isActive = null,Object? publishedAt = null,Object? authorName = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String noticeId,  String title,  String content,  List<String> imageUrls,  String category,  bool isPinned,  bool isActive,  DateTime publishedAt,  String authorName,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NoticeModel() when $default != null:
return $default(_that.noticeId,_that.title,_that.content,_that.imageUrls,_that.category,_that.isPinned,_that.isActive,_that.publishedAt,_that.authorName,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String noticeId,  String title,  String content,  List<String> imageUrls,  String category,  bool isPinned,  bool isActive,  DateTime publishedAt,  String authorName,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _NoticeModel():
return $default(_that.noticeId,_that.title,_that.content,_that.imageUrls,_that.category,_that.isPinned,_that.isActive,_that.publishedAt,_that.authorName,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String noticeId,  String title,  String content,  List<String> imageUrls,  String category,  bool isPinned,  bool isActive,  DateTime publishedAt,  String authorName,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _NoticeModel() when $default != null:
return $default(_that.noticeId,_that.title,_that.content,_that.imageUrls,_that.category,_that.isPinned,_that.isActive,_that.publishedAt,_that.authorName,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _NoticeModel extends NoticeModel {
  const _NoticeModel({required this.noticeId, required this.title, required this.content, final  List<String> imageUrls = const <String>[], this.category = 'notice', this.isPinned = false, this.isActive = true, required this.publishedAt, this.authorName = 'VYBE 운영팀', required this.createdAt, required this.updatedAt}): _imageUrls = imageUrls,super._();
...
@override
int get hashCode => Object.hash(runtimeType,noticeId,title,content,const DeepCollectionEquality().hash(_imageUrls),category,isPinned,isActive,publishedAt,authorName,createdAt,updatedAt);
...
/// Create a copy of NoticeModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? noticeId = null,Object? title = null,Object? content = null,Object? imageUrls = null,Object? category = null,Object? isPinned = null,Object? isActive = null,Object? publishedAt = null,Object? authorName = null,Object? createdAt = null,Object? updatedAt = null,}) {
