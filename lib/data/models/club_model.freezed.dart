...
mixin _$ClubModel {
 ...
 String get clubId; String get name; String get description; String get address; String get area; String get phone; String get instagramUrl; double get lat; double get lng; String get geohash; String get genre; double get rating; int get reviewCount; OperatingHours get operatingHours; int get entryFeeMin; int get entryFeeMax; List<String> get imageUrls; List<String> get heroImageUrls; String get thumbnailUrl; List<String> get menuBoardUrls; List<String> get tags; int get favoriteCount; bool get isActive; bool get isVybeRecommended; bool get isNonSmoking; ServiceDrink get serviceDrink; String get freeEntryCondition;/// 무료입장 정책 — 상시 / 시간대 / 없음. 지금 무료인지는 `freeEntry.statusAt()`.
...
class _ClubModel extends ClubModel {
  const _ClubModel({required this.clubId, required this.name, required this.description, required this.address, required this.area, required this.phone, required this.instagramUrl, required this.lat, required this.lng, required this.geohash, required this.genre, required this.rating, this.reviewCount = 0, this.operatingHours = const OperatingHours(), required this.entryFeeMin, required this.entryFeeMax, required final  List<String> imageUrls, final  List<String> heroImageUrls = const [], required this.thumbnailUrl, final  List<String> menuBoardUrls = const [], required final  List<String> tags, required this.favoriteCount, required this.isActive, required this.isVybeRecommended, this.isNonSmoking = false, this.serviceDrink = ServiceDrink.none, this.freeEntryCondition = '', this.freeEntry = FreeEntryPolicy.none, this.isFreeEntry = false, required this.createdAt, required this.updatedAt}): _imageUrls = imageUrls,_heroImageUrls = heroImageUrls,_menuBoardUrls = menuBoardUrls,_tags = tags,super._();
