...
mixin _$ClubModel {
 ...
 String get clubId; String get name; String get description; String get address; String get area; String get phone; String get instagramUrl; double get lat; double get lng; String get geohash; String get genre; List<String> get genreStyles;// 세부 장르 스타일(트랩/붐뱁 등) — 장르 페이지 포스터 #태그
 double get rating; int get reviewCount; OperatingHours get operatingHours; int get entryFeeMin; int get entryFeeMax; List<String> get imageUrls; List<String> get heroImageUrls; String get thumbnailUrl; List<String> get menuBoardUrls; List<String> get tags; int get favoriteCount; bool get isActive; bool get isVybeRecommended; bool get isNonSmoking; ServiceDrink get serviceDrink; String get freeEntryCondition;/// 무료입장 정책 — 상시 / 시간대 / 없음. 지금 무료인지는 `freeEntry.statusAt()`.
 FreeEntryPolicy get freeEntry;/// `freeEntry.type != none` 파생값. 쿼리·필터 전용 (판정에는 쓰지 않는다).
 bool get isFreeEntry; DateTime get createdAt; DateTime get updatedAt;
...
@useResult
$Res call({
 String clubId, String name, String description, String address, String area, String phone, String instagramUrl, double lat, double lng, String geohash, String genre, List<String> genreStyles, double rating, int reviewCount, OperatingHours operatingHours, int entryFeeMin, int entryFeeMax, List<String> imageUrls, List<String> heroImageUrls, String thumbnailUrl, List<String> menuBoardUrls, List<String> tags, int favoriteCount, bool isActive, bool isVybeRecommended, bool isNonSmoking, ServiceDrink serviceDrink, String freeEntryCondition, FreeEntryPolicy freeEntry, bool isFreeEntry, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of ClubModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? clubId = null,Object? name = null,Object? description = null,Object? address = null,Object? area = null,Object? phone = null,Object? instagramUrl = null,Object? lat = null,Object? lng = null,Object? geohash = null,Object? genre = null,Object? genreStyles = null,Object? rating = null,Object? reviewCount = null,Object? operatingHours = null,Object? entryFeeMin = null,Object? entryFeeMax = null,Object? imageUrls = null,Object? heroImageUrls = null,Object? thumbnailUrl = null,Object? menuBoardUrls = null,Object? tags = null,Object? favoriteCount = null,Object? isActive = null,Object? isVybeRecommended = null,Object? isNonSmoking = null,Object? serviceDrink = null,Object? freeEntryCondition = null,Object? freeEntry = null,Object? isFreeEntry = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
as String,genreStyles: null == genreStyles ? _self.genreStyles : genreStyles // ignore: cast_nullable_to_non_nullable
as List<String>,rating: null == rating ? _self.rating : rating // ignore: cast_nullable_to_non_nullable
as double,reviewCount: null == reviewCount ? _self.reviewCount : reviewCount // ignore: cast_nullable_to_non_nullable
as int,operatingHours: null == operatingHours ? _self.operatingHours : operatingHours // ignore: cast_nullable_to_non_nullable
...
as bool,isNonSmoking: null == isNonSmoking ? _self.isNonSmoking : isNonSmoking // ignore: cast_nullable_to_non_nullable
as bool,serviceDrink: null == serviceDrink ? _self.serviceDrink : serviceDrink // ignore: cast_nullable_to_non_nullable
as ServiceDrink,freeEntryCondition: null == freeEntryCondition ? _self.freeEntryCondition : freeEntryCondition // ignore: cast_nullable_to_non_nullable
as String,freeEntry: null == freeEntry ? _self.freeEntry : freeEntry // ignore: cast_nullable_to_non_nullable
as FreeEntryPolicy,isFreeEntry: null == isFreeEntry ? _self.isFreeEntry : isFreeEntry // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ClubModel() when $default != null:
return $default(_that.clubId,_that.name,_that.description,_that.address,_that.area,_that.phone,_that.instagramUrl,_that.lat,_that.lng,_that.geohash,_that.genre,_that.genreStyles,_that.rating,_that.reviewCount,_that.operatingHours,_that.entryFeeMin,_that.entryFeeMax,_that.imageUrls,_that.heroImageUrls,_that.thumbnailUrl,_that.menuBoardUrls,_that.tags,_that.favoriteCount,_that.isActive,_that.isVybeRecommended,_that.isNonSmoking,_that.serviceDrink,_that.freeEntryCondition,_that.freeEntry,_that.isFreeEntry,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _ClubModel extends ClubModel {
  const _ClubModel({required this.clubId, required this.name, required this.description, required this.address, required this.area, required this.phone, required this.instagramUrl, required this.lat, required this.lng, required this.geohash, required this.genre, final  List<String> genreStyles = const [], required this.rating, this.reviewCount = 0, this.operatingHours = const OperatingHours(), required this.entryFeeMin, required this.entryFeeMax, required final  List<String> imageUrls, final  List<String> heroImageUrls = const [], required this.thumbnailUrl, final  List<String> menuBoardUrls = const [], required final  List<String> tags, required this.favoriteCount, required this.isActive, required this.isVybeRecommended, this.isNonSmoking = false, this.serviceDrink = ServiceDrink.none, this.freeEntryCondition = '', this.freeEntry = FreeEntryPolicy.none, this.isFreeEntry = false, required this.createdAt, required this.updatedAt}): _genreStyles = genreStyles,_imageUrls = imageUrls,_heroImageUrls = heroImageUrls,_menuBoardUrls = menuBoardUrls,_tags = tags,super._();
...
@override final  String genre;
 final  List<String> _genreStyles;
@override@JsonKey() List<String> get genreStyles {
  if (_genreStyles is EqualUnmodifiableListView) return _genreStyles;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_genreStyles);
}

// 세부 장르 스타일(트랩/붐뱁 등) — 장르 페이지 포스터 #태그
...
@override@JsonKey() final  bool isNonSmoking;
@override@JsonKey() final  ServiceDrink serviceDrink;
@override@JsonKey() final  String freeEntryCondition;
/// 무료입장 정책 — 상시 / 시간대 / 없음. 지금 무료인지는 `freeEntry.statusAt()`.
@override@JsonKey() final  FreeEntryPolicy freeEntry;
...
as double,geohash: null == geohash ? _self.geohash : geohash // ignore: cast_nullable_to_non_nullable
as String,genre: null == genre ? _self.genre : genre // ignore: cast_nullable_to_non_nullable
as String,genreStyles: null == genreStyles ? _self._genreStyles : genreStyles // ignore: cast_nullable_to_non_nullable
as List<String>,rating: null == rating ? _self.rating : rating // ignore: cast_nullable_to_non_nullable
as double,reviewCount: null == reviewCount ? _self.reviewCount : reviewCount // ignore: cast_nullable_to_non_nullable
as int,operatingHours: null == operatingHours ? _self.operatingHours : operatingHours // ignore: cast_nullable_to_non_nullable
as OperatingHours,entryFeeMin: null == entryFeeMin ? _self.entryFeeMin : entryFeeMin // ignore: cast_nullable_to_non_nullable
