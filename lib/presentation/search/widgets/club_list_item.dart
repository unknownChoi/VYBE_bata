...
class ClubListItem extends StatelessWidget {
      ...
      children: [
        ...
        if (club.isVybeRecommended) ...[
          ...
          Row(
            ...
            children: [
              SvgPicture.asset(
                'assets/icons/search_screen/vybe_recommend.svg',
                width: 12.r,
                height: 12.r,
              ),
              SizedBox(width: 2.w),
  ...
  Widget _buildRatingTagRow() {
    ...
    return Row(
      children: [
        SvgPicture.asset(
          'assets/icons/search_screen/rank_rate_star.svg',
          width: 14.r,
          height: 14.r,
        ),
        SizedBox(width: 4.w),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: SvgPicture.asset(
                'assets/icons/search_screen/favorite.svg',
                width: 24.r,
                height: 24.r,
              ),
            ),
    ...
    return Row(
      children: [
        SizedBox(
          ...
          child: Center(
            child: SvgPicture.asset(
              'assets/icons/search_screen/club_card_lcation_pin.svg',
              width: 14.r,
              height: 14.r,
            ),
          ),
    ...
    return Row(
      children: [
        SizedBox(
          ...
          child: Center(
            child: SvgPicture.asset(
              'assets/icons/search_screen/club_card_time.svg',
              width: 13.r,
              height: 13.r,
            ),
          ),
        ...
        SizedBox(width: 24.w),
        SvgPicture.asset(
          'assets/icons/search_screen/club_card_won.svg',
          width: 16.r,
          height: 16.r,
        ),
        SizedBox(width: 8.w),
