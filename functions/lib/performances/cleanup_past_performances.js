...
exports.cleanupPastPerformances = void 0;
...
// - 8시간 전 시작 (확실히 종료)          → 삭제
exports.cleanupPastPerformances = v1_1.pubsub
    ...
    const snap = await db
        ...
        .get();
    if (snap.empty) {
        v1_1.logger.info("cleanupPastPerformances: no past performances");
        return;
    }
    ...
    v1_1.logger.info(`cleanupPastPerformances: deleted ${docs.length} performances ` +
        `(startAt < ${cutoff.toDate().toISOString()})`);
});
//# sourceMappingURL=cleanup_past_performances.js.map