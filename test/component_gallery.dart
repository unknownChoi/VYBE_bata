...
//
// 실행 방법:
//   flutter run -t test/component_gallery.dart
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:vybe/core/theme/app_theme.dart';
import 'package:vybe/design_system/colors.dart';
import 'package:vybe/presentation/auth/welcome_screen.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            VybeButton(
              label: '텍스트 버튼',
              onTap: () {},
              variant: VybeButtonVariant.textButton,
            ),
            _Divider(),
            ...
            SizedBox(height: 12.h),
            VybeStatusMessage(
              message: '상태 관련 메시지를 입력하세요.',
              type: VybeStatusType.warn,
            ),
            SizedBox(height: 12.h),
            VybeStatusMessage(
              message: '상태 관련 메시지를 입력하세요.',
              type: VybeStatusType.error,
            ),
            SizedBox(height: 12.h),
            VybeStatusMessage(
              message: '상태 관련 메시지를 입력하세요.',
              type: VybeStatusType.success,
            ),
            _Divider(),
            ...
            SizedBox(height: 24.h),
            _Label('Error'),
            VybeCertificateInput(errorText: '인증번호가 올바르지 않습니다.'),
            SizedBox(height: 24.h),
            _Label('Disabled'),
